<script>import Navbar from  "../components/Navbar.svelte";</script>
<Navbar />
<section>
	<div class="flex flex-col mb-10 pt-24 items-center" id="rules">
		<p
			class="text-7xl text-transparent bg-clip-text font-geo bg-warning"
		>
			About our school
		</p>
		<div class="flex">
			<div class="mb-2 flex space-x-2  m-10">
				...
				<p class="text-3xl py-10 text-center text-warning">
					<strong><u>General Rules</u></strong><br>
					<br>
